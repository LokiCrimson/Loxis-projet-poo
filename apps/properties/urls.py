...
urlpatterns = [
    ...
    path('biens/<int:property_id>/incidents/', apis.PropertyIncidentListCreateApi.as_view(), name='gestion-incidents-bien'),
    # Avis et notations
    path('biens/<int:property_id>/avis/', apis.PropertyReviewListCreateApi.as_view(), name='liste-creation-avis'),
]