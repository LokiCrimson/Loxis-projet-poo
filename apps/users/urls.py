...
urlpatterns = [
    ...
    # Profile connecte
    path('me/', apis.UserMeApi.as_view(), name='user-me'),
    path('mot-de-passe/modifier/', apis.ChangePasswordApi.as_view(), name='modifier-mot-de-passe'),

    # Gestion des comptes utilisateurs et rÃles
    ...
    path('locataires/<int:tenant_id>/', apis.TenantDetailApi.as_view(), name='detail-locataire'),
